    ...
    <footer className="bg-warm-charcoal">
      ...
      <div className="content-width py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-4">
              <a
                ...
                aria-label="NammaOffice on Instagram"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="NammaOffice on LinkedIn"
                className="text-white/60 hover:text-terracotta transition-colors"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="NammaOffice on Facebook"
                className="text-white/60 hover:text-terracotta transition-colors"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="NammaOffice on YouTube"
                className="text-white/60 hover:text-terracotta transition-colors"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          {/* Column 2: Workspaces */}
          <div>
            <h3 className="text-white font-serif text-base mb-4">Workspaces</h3>
            <ul className="space-y-2.5">
              {workspaceLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/80 text-sm hover:text-terracotta transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Column 3: Locations */}
          <div>
            <h3 className="text-white font-serif text-base mb-4">Locations</h3>
            <ul className="space-y-2.5">
          ...
          {/* Column 4: Company */}
          <div>
            <h3 className="text-white font-serif text-base mb-4">Company</h3>
            <ul className="space-y-2.5">
          ...
          {/* Column 5: Legal */}
          <div>
            <h3 className="text-white font-serif text-base mb-4">Legal</h3>
            <ul className="space-y-2.5">
              {legalLinks.map((link) => (
                <li key={link.href}>
                  <Link

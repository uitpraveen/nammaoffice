  ...
  return (
    <>
      ...
      <section className="content-width py-12 md:py-16">
        <div className={aside ? "grid lg:grid-cols-[1fr_320px] gap-10" : ""}>
          <div>
            {intro && (
            ...
            <div className="rounded-2xl bg-white border border-[var(--color-border)] shadow-[var(--shadow-brand)] p-6 md:p-8">
              {children}
            </div>
          </div>
          {aside && (

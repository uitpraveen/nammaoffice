        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {locations.map((loc) => (
            <Link
              ...
              className="group relative block aspect-[4/5] rounded-2xl overflow-hidden bg-[var(--color-surface-alt)] transition-all duration-300 hover:shadow-[0_0_0_1px_rgba(184,85,58,0.50),0_20px_40px_-12px_rgba(184,85,58,0.30)] hover:-translate-y-0.5"
            >
              {loc.images[0] && (
                <Image
                  src={loc.images[0]}
